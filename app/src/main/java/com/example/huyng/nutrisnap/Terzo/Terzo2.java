...
public class Terzo2 extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.terzo2);
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayGrassi1 = SayBuilder.with(qiContext).withText("\\rspd=85\\ Cresco quando il sole è bello...").build();

        //Say spiegazione Grassi
        sayGrassi1.run();

        Intent activity2Intent = new Intent(getApplicationContext(), Terzo3.class);
