...
public class Fatadomanda2 extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fatadomanda2);
    }


    //Funzione per il Bottone Talpa
    public void Talpa(View view) {
        Intent activity2Intent = new Intent(getApplicationContext(), Domanda2corretta.class);
    ...
    public void Scoiattolo(View view) {
        Intent activity2Intent = new Intent(getApplicationContext(), Domanda2errata.class);
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayScelta1 = SayBuilder.with(qiContext)
                .withText("La pianta con i fiorellini viola era?").build();

        Say sayScelta2 = SayBuilder.with(qiContext)
                .withText(" Rosmarino?").build();

        Say sayScelta3 = SayBuilder.with(qiContext)
                .withText(" Oppure lavanda?").build();
...
// Create the phraseSetLearn Talpa.
        PhraseSet phraseSetLearn = PhraseSetBuilder.with(qiContext) // Create the builder using the QiContext.
                .withTexts("Rosmarino") // Add the phrases Pepper will listen to.
        ...
        PhraseSet phraseSetPlay = PhraseSetBuilder.with(qiContext) // Create the builder using the QiContext.
                .withTexts("Lavanda") // Add the phrases Pepper will listen to.
                .build(); // Build the PhraseSet
