...
public class Acqua3 extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acqua3);
    }
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayAcqua1 = SayBuilder.with(qiContext).withText(" Ancor di più quando si fa esercizio fisico o quando fuori fa caldo.").build();

        //Say spiegazione Acqua
        sayAcqua1.run();

        Say sayFinale = SayBuilder.with(qiContext).withText("Ora sai davvero tutto sull'acqua.").build();
...
// Run the listen action and get the result.
        ...
        if (PhraseSetUtil.equals(matchedPhraseSet, phraseSetBack)) {
            ...
            startActivity(activity2Intent); //Per ripetere spiegazione Acqua
        }
