...
public class Terzo4 extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.terzo4);
    }
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayScelta1 = SayBuilder.with(qiContext)
                .withText("\\rspd=95\\Il basilico lo adoro...").build();

        Say sayScelta2 = SayBuilder.with(qiContext)
                .withText("\\rspd=95\\ Sono il rosso?").build();
        ...
        if (PhraseSetUtil.equals(matchedPhraseSet, phraseSetLearn)) {
            //Andare nella pagina successiva
            Intent activity2Intent = new Intent(getApplicationContext(), Terzo5.class);
