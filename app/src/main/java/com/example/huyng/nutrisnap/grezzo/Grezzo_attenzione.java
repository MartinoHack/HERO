...
public class Grezzo_attenzione extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    public void ButtonSi(View view) {
        Intent activity2Intent = new Intent(getApplicationContext(), GrezzoStory2.class);
