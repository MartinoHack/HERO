...
public class DomandaG1corretta extends RobotActivity implements RobotLifecycleCallbacks {
    MediaPlayer end;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.grezzocorretta);
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Intent activity2Intent = new Intent(getApplicationContext(), Grezzodomanda2.class);
