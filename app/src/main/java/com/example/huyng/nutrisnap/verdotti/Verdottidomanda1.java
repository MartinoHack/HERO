...
public class Verdottidomanda1 extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.verdottidomanda1);
    }


    //Funzione per il Bottone Talpa
    public void uno(View view) {
        Intent activity2Intent = new Intent(getApplicationContext(), DomandaVcorretta.class);
    ...
    public void due(View view) {
        Intent activity2Intent = new Intent(getApplicationContext(), DomandaVerrata.class);
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayScelta1 = SayBuilder.with(qiContext)
                .withText("Come di chiama il mondo dove vivono i verdotti?").build();

        Say sayScelta2 = SayBuilder.with(qiContext)
                .withText(" Mangiabosco?").build();

        Say sayScelta3 = SayBuilder.with(qiContext)
                .withText(" Oppure Chimangiacosa?").build();
...
// Create the phraseSetLearn Talpa.
        PhraseSet phraseSetLearn = PhraseSetBuilder.with(qiContext) // Create the builder using the QiContext.
                .withTexts("Chimangiacosa", "Chi mangia cosa") // Add the phrases Pepper will listen to.
        ...
        PhraseSet phraseSetPlay = PhraseSetBuilder.with(qiContext) // Create the builder using the QiContext.
                .withTexts("Mangiabosco", "Mangia Bosco") // Add the phrases Pepper will listen to.
                .build(); // Build the PhraseSet
