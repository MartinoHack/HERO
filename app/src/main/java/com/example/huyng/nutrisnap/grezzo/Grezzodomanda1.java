...
public class Grezzodomanda1 extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.grezzodomanda1);
    }


    //Funzione per il Bottone bianco
    public void Bianco(View view) {
        Intent activity2Intent = new Intent(getApplicationContext(), DomandaG1errata.class);
    ...
    public void Scuro(View view) {
        Intent activity2Intent = new Intent(getApplicationContext(), DomandaG1corretta.class);
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayScelta1 = SayBuilder.with(qiContext)
                .withText("\\rspd=80\\ Di che colore era Grezzo?").build();

        Say sayScelta2 = SayBuilder.with(qiContext)
                .withText(" Era bianco?").build();

        Say sayScelta3 = SayBuilder.with(qiContext)
                .withText(" O scuro?").build();
...
// Create the phraseSetLearn Talpa.
        PhraseSet phraseSetLearn = PhraseSetBuilder.with(qiContext) // Create the builder using the QiContext.
                .withTexts("Scuro", "Era scuro") // Add the phrases Pepper will listen to.
        ...
        PhraseSet phraseSetPlay = PhraseSetBuilder.with(qiContext) // Create the builder using the QiContext.
                .withTexts("Bianco", "Era bianco") // Add the phrases Pepper will listen to.
                .build(); // Build the PhraseSet
