...
public class Terzo1 extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.terzo1);
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayGrassi1 = SayBuilder.with(qiContext).withText("\\rspd=85\\ Sono tondo e paffutello...").build();

        //Say spiegazione Grassi
        sayGrassi1.run();

        Intent activity2Intent = new Intent(getApplicationContext(), Terzo2.class);
