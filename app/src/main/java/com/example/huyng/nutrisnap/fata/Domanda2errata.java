...
public class Domanda2errata extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fataerrata2);
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayVerdotti1 = SayBuilder.with(qiContext).withText(" Oh no!! La tua risposta è sbagliata! La risposta esatta era IL rosmarino! ").build();
