...
import com.example.huyng.nutrisnap.MenuImpariamoGiochiamoActivity;
import com.example.huyng.nutrisnap.MenuStorie;
import com.example.huyng.nutrisnap.R;

public class Fata_attenzione extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    public void ButtonSi(View view) {
        Intent activity2Intent = new Intent(getApplicationContext(), FataStory2.class);
