...
public class SemaforoVerde extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button = findViewById(R.id.imageView44);
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayVerdotti1 = SayBuilder.with(qiContext).withText("Hai deciso di accendere la luce verde. Giudice è corretto?").build();
