...
import com.example.huyng.nutrisnap.fata.Fatadomanda2;

public class DomandaVerrata extends RobotActivity implements RobotLifecycleCallbacks {
    MediaPlayer end;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.verdottierrata);
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayVerdotti1 = SayBuilder.with(qiContext).withText(" Oh no!! La tua risposta è sbagliata! La risposta esatta era Chimangiacosa! ").build();
        ...
        Intent activity2Intent = new Intent(getApplicationContext(), Verdottidomanda2.class);
