...
public class GialloPepper extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayVerdotti1 = SayBuilder.with(qiContext).withText("Decido di accendere la luce gialla. Giudice è corretto?").build();
