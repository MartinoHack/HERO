...
public class QuizResult extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    public void Riprova(View view) {
        Intent activity2Intent = new Intent(getApplicationContext(), Quiz1.class);
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayFrasefinale = SayBuilder.with(qiContext)
                .withText("Bravissimo!! Hai concluso il quiz con un punteggio di " +score+ "punti." ).build();
