...
public class Carboidrati3 extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carboidrati3);
    }
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayCarbo = SayBuilder.with(qiContext)
                .withText(" Si possono dividere in carboidrati semplici e complessi.").build();
        Say sayCarbo2 = SayBuilder.with(qiContext)
                .withText(" Quelli complessi forniscono energia in maniera graduale mentre quelli semplici danno energia immediata.").build();

        //Say spiegazione
        sayCarbo.run();
        sayCarbo2.run();
        Intent activity2Intent = new Intent(getApplicationContext(), Carboidrati4.class);
