...
public class DomandaVcorretta extends RobotActivity implements RobotLifecycleCallbacks {
    MediaPlayer end;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.verdotticorretta);
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayVerdotti1 = SayBuilder.with(qiContext).withText(" Complimenti!! La risposta è corretta.  Passiamo alla prossima domanda! ").build();
