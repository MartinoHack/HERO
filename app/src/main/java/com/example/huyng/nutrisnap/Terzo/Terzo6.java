...
public class Terzo6 extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.terzo6);
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayGrassi1 = SayBuilder.with(qiContext).withText("\\rspd=85\\ Scura scura, oppure viola...").build();

        //Say spiegazione Grassi
        sayGrassi1.run();

        Intent activity2Intent = new Intent(getApplicationContext(), Terzo7.class);
