...
public class DomandaG1errata extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.grezzoerrata);
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayVerdotti1 = SayBuilder.with(qiContext).withText(" Oh no!! La tua risposta è sbagliata! La risposta esatta era Scuro! ").build();
