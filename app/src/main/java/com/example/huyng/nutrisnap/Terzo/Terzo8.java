...
public class Terzo8 extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.terzo8);
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayGrassi1 = SayBuilder.with(qiContext).withText("\\rspd=85\\ Chi mi griglia chi mi impana, chi mi fa alla parmigiana. ").build();

        //Say spiegazione Grassi
        sayGrassi1.run();

        Intent activity2Intent = new Intent(getApplicationContext(), Terzo9.class);
