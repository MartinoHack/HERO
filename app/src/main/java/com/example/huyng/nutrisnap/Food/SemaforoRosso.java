...
public class SemaforoRosso extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.semafororosso);

        button = findViewById(R.id.imageView49);
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayVerdotti1 = SayBuilder.with(qiContext).withText("Hai deciso di accendere la luce rossa. Giudice è corretto?").build();
        Say sayAndiamo = SayBuilder.with(qiContext).withText("Ben fatto!. Hai guadagnato un punto!").build();
        Say sayAndiamo2 = SayBuilder.with(qiContext).withText("Mi dispiace ma non è corretto, non guadagni punti.").build();
