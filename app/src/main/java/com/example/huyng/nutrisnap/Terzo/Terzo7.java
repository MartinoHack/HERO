...
public class Terzo7 extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.terzo7);
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayGrassi1 = SayBuilder.with(qiContext).withText("\\rspd=85\\ Prendo tutti per la gola.").build();

        //Say spiegazione Grassi
        sayGrassi1.run();

        Intent activity2Intent = new Intent(getApplicationContext(), Terzo8.class);
