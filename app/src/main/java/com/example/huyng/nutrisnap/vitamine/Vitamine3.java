...
public class Vitamine3 extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vitamine3);
    }
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Say sayVitamine1 = SayBuilder.with(qiContext).withText(" E verdure a foglia verde come spinaci broccoli e carote.").build();


        //Say spiegazione Vitamine
        sayVitamine1.run();

        Intent activity2Intent = new Intent(getApplicationContext(), Vitamine4.class);
